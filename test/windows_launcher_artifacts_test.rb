...
class WindowsLauncherArtifactsTest < ActiveSupport::TestCase
  ...
  test "windows splash helper reads launcher progress and validates without launching" do
    ...
    assert_includes splash_script, "Get-SplashMutexName"
    assert_includes splash_script, "System.Threading.Mutex"
    assert_includes splash_script, "LewisMD-Splash-"
    assert_includes splash_script, "LewisMDSplashNativeMethods"
    assert_includes splash_script, "GetConsoleWindow"
    assert_includes splash_script, "Hide-ConsoleWindow"
    assert_includes splash_script, "Promote-SplashWindow"
    assert_includes splash_script, 'ShowActivated="True"'
    assert_includes splash_script, "$window.Add_ContentRendered"
  ...
  test "hidden launcher starts the splash helper before launching the app" do
    ...
    assert_includes hidden_launcher, "-Sta -ExecutionPolicy Bypass -File"
