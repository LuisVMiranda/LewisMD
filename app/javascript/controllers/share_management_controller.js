...
export default class extends Controller {
  ...
  statusPill(label, tone) {
    ...
    return `<span class="inline-flex items-center rounded-full border px-[22px] py-0.5 text-[11px] font-medium uppercase tracking-wide ${toneClasses}">${this.escapeHtml(label)}</span>`
  }
